...
pub struct CorridorLowerboundPotentialServer {
    graph: CapacityGraph,
    dijkstra: DijkstraData<Weight, EdgeIdT, Weight>,
    customized: CustomizedCorridorLowerbound,
    requires_pot_update: bool,
}

impl CorridorLowerboundPotentialServer {
    pub fn new(graph: CapacityGraph, customized: CustomizedCorridorLowerbound) -> Self {
    ...
    pub fn decompose(self) -> (CapacityGraph, CustomizedCorridorLowerbound) {
...
impl CapacityServerOps for CorridorLowerboundPotentialServer {
